...
const DashboardLayout = () => {
  ...
  const listItems = [
    ...
    { id: 2, title: "Men's clothing", type: "dropdown", subItems: ["T-Shirts", "Hoodies", "Sweatshitrs"] },
    { id: 3, title: "Women's clothing", type: "dropdown", subItems: ["Shirts", "Pants", "Accessories"] },
                            ...
                            {item.type === "dropdown" && (
                              <>
                                <ListGroup.Item
                                  ...
                                  onClick={() => toggleExpandSubMenu(item.id)}
                                >
                                  {/* Trailing Section */}
                                  <div className="d-flex align-items-center ">
                                    <span >{item.title}</span>
                                    {item.type === "dropdown" && (
                                      expandedItems[item.id] ? <FaChevronUp  className='ms-auto'/> : <FaChevronDown  className='ms-auto'/>
                                    )}
                                  </div>
                                  ...
                                  <div>
                                    {/* Dropdown Sub-Items */}
                                    {item.type === "dropdown" && expandedItems[item.id] && (
                                      <div
                                        style={{
                                          marginLeft: "20px",
                                          backgroundColor: "transparent",
                                      ...
                                      >
                                        {item.subItems.map((subItem, index) => (<>
                                          <a style={{ textDecoration: "none", cursor: "pointer" }} key={index} >
                                            {subItem}
                                          </a>
                                          <br />
                                        </>
