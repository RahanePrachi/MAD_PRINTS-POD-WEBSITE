    ...
    <div className=" bg-[#F1F1FF]">
      ...
      <div className="w-10/12 mx-auto flex flex-col lg:flex-row">
        ...
        <div className="flex flex-col gap-5 lg:w-1/2">
          ...
          <button onClick={handleClick} className="font-manrope font-bold text-md text-white bg-[#FB5711] w-full lg:w-[219px] py-3 lg:py-8 px-6 lg:px-18 rounded-lg mb-5" style={{ fontFamily: "'Manrope', sans-serif" }}>
            Get Started
          </button>
        </div>
